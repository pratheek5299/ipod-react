      ...
      <div className="music-info-wrapper">
        <div className="music-image">
          <audio id="audioElement" preload="none">
            <source src="../audio/audio_clip.mp3" />
          </audio>
          <img
            src="https://img.freepik.com/free-vector/abstract-flat-line-with-music-note-motion-shapes-pattern-cover-design-poster-banner-decoration_460848-15092.jpg"
            alt=""
          />
        </div>
        <div className="music-info">
          <h4>Audio Soundtrack</h4>
          <p>Unkown Artist</p>
        </div>
      </div>
